...
rule hifiasm_hic_purging_old:
	...
	input:
		...
		maximum_depth = os.path.join(config['results'], prefix, "genome_profiling", "maximum_depth.txt")
	output:
		l1_hap1_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hic.hap1.p_ctg.gfa'),
		l1_hap2_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hic.hap2.p_ctg.gfa'),
		l2_hap1_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hic.hap1.p_ctg.gfa'),
		l2_hap2_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hic.hap2.p_ctg.gfa'),
		l3_hap1_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hic.hap1.p_ctg.gfa'),
		l3_hap2_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hic.hap2.p_ctg.gfa')

	params:
		hifiasm_path = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging"),
		prefix_l1 = prefix + '_l1Hi',
		prefix_l2 = prefix + '_l2Hi',
		prefix_l3 = prefix + '_l3Hi'
	log:
		l1_log = os.path.join(config['results'], "logs", prefix, 'hifiasm_hic_purging_l1.log'),
		l2_log = os.path.join(config['results'], "logs", prefix, 'hifiasm_hic_purging_l2.log'),
		l3_log = os.path.join(config['results'], "logs", prefix, 'hifiasm_hic_purging_l3.log')
	...
	shell:
		...
		mkdir -p {params.hifiasm_path}/{params.prefix_l1}
		mkdir -p {params.hifiasm_path}/{params.prefix_l2}
		mkdir -p {params.hifiasm_path}/{params.prefix_l3}
		
		(hifiasm -o {params.hifiasm_path}/{params.prefix_l1}/{params.prefix_l1} -t {threads} --primary -l1 --purge-max $MAX_DEPTH --h1 {input.hic1} --h2 {input.hic2} {input.hifi_fastq}) 2> {log.l1_log}

		mv {params.hifiasm_path}/{params.prefix_l1}/{params.prefix_l1}.ovlp.source.bin {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2}.ovlp.source.bin
		mv {params.hifiasm_path}/{params.prefix_l1}/{params.prefix_l1}.ovlp.reverse.bin {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2}.ovlp.reverse.bin
		mv {params.hifiasm_path}/{params.prefix_l1}/{params.prefix_l1}.ec.bin {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2}.ec.bin

		(hifiasm -o {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2} -t {threads} --primary -l2 --purge-max $MAX_DEPTH --h1 {input.hic1} --h2 {input.hic2} {input.hifi_fastq}) 2> {log.l2_log}

		mv {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2}.ovlp.source.bin {params.hifiasm_path}/{params.prefix_l3}/{params.prefix_l3}.ovlp.source.bin
		mv {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2}.ovlp.reverse.bin {params.hifiasm_path}/{params.prefix_l3}/{params.prefix_l3}.ovlp.reverse.bin
		mv {params.hifiasm_path}/{params.prefix_l2}/{params.prefix_l2}.ec.bin {params.hifiasm_path}/{params.prefix_l3}/{params.prefix_l3}.ec.bin

		(hifiasm -o {params.hifiasm_path}/{params.prefix_l3}/{params.prefix_l3} -t {threads} --primary -l3 --purge-max $MAX_DEPTH --h1 {input.hic1} --h2 {input.hic2} {input.hifi_fastq}) 2> {log.l3_log}	
		"""
...
rule hifiasm_hic_purging_gfa_to_fasta_old:
	"""Convert the GFA output from Hifiasm into a FASTA format. """
	input:
		l1_hap1_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hic.hap1.p_ctg.gfa'),
		l1_hap2_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hic.hap2.p_ctg.gfa'),
		l1_p_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hic.p_ctg.gfa'),
		l1_a_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hic.a_ctg.gfa'),
		
		l2_hap1_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hic.hap1.p_ctg.gfa'),
		l2_hap2_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hic.hap2.p_ctg.gfa'),
		l2_p_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hic.p_ctg.gfa'),
		l2_a_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hic.a_ctg.gfa'),
				
		l3_hap1_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hic.hap1.p_ctg.gfa'),
		l3_hap2_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hic.hap2.p_ctg.gfa'),		
		l3_p_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hic.p_ctg.gfa'),
		l3_a_gfa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hic.a_ctg.gfa'),
	output:
		l1_hap1_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hap1.p_ctg.fa'),
		l1_hap2_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.hap2.p_ctg.fa'),
		l1_p_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.p_ctg.fa'),
		l1_a_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l1Hi', prefix + '_l1Hi.a_ctg.fa'),	
		
		l2_hap1_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hap1.p_ctg.fa'),
		l2_hap2_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.hap2.p_ctg.fa'),
		l2_p_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.p_ctg.fa'),
		l2_a_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l2Hi', prefix + '_l2Hi.a_ctg.fa'),

		l3_hap1_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hap1.p_ctg.fa'),
		l3_hap2_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.hap2.p_ctg.fa'),
		l3_p_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.p_ctg.fa'),
		l3_a_fa = os.path.join(config['results'], prefix, "contigging/hifiasm_hic_purging", prefix + '_l3Hi', prefix + '_l3Hi.a_ctg.fa'),
	threads:
		resource['hifiasm_hic_gfa_to_fasta']['threads']
	resources: 
		mem_mb=resource['hifiasm_hic_gfa_to_fasta']['mem_mb'],
		time=resource['hifiasm_hic_gfa_to_fasta']['time']
	log:
		os.path.join(config['results'], "logs", prefix, 'hifiasm_hic_purging_gfa_to_fa.log')
	shell:
		"""awk '/^S/{{print ">"$2;print $3}}' {input.l1_hap1_gfa} > {output.l1_hap1_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l1_hap2_gfa} > {output.l1_hap2_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l1_p_gfa} > {output.l1_p_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l1_a_gfa} > {output.l1_a_fa} 2> {log};

		awk '/^S/{{print ">"$2;print $3}}' {input.l2_hap1_gfa} > {output.l2_hap1_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l2_hap2_gfa} > {output.l2_hap2_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l2_p_gfa} > {output.l2_p_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l2_a_gfa} > {output.l2_a_fa} 2> {log};

		awk '/^S/{{print ">"$2;print $3}}' {input.l3_hap1_gfa} > {output.l3_hap1_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l3_hap1_gfa} > {output.l3_hap2_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l3_p_gfa} > {output.l3_p_fa} 2> {log};
		awk '/^S/{{print ">"$2;print $3}}' {input.l3_a_gfa} > {output.l3_a_fa} 2> {log};
		"""
